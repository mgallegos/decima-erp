...
Form::macro('datecustom', function($name, $options = array(), $value = null, $btnClass = 'btn-default', $bootstrapVersion = '3', $yearRange = 'c-10:c+10', $prefixIcon = '', $prefixButton = false)
{
	if(empty($btnClass))
	{
		$btnClass = 'btn-default';
...
Form::macro('datetimecustom', function($name, $options = array(), $value = null, $btnClass = 'btn-default', $bootstrapVersion = '3', $prefixIcon = '', $prefixButton = false)
{
	if ( ! isset($options['name']))
  {
		$options['name'] = $name;
