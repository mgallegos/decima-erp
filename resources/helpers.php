...
if ( ! function_exists('eloquent_array_filter'))
{
 ...
 if ( ! function_exists('remove_thousands_separator'))
 {
  ...
  if ( ! function_exists('replace_special_characters'))
  {
    ...
    {
      $notAllowed = array ("á","é","í","ó","ú","Á","É","Í","Ó","Ú","À","Ã","Ì","Ò","ñ","Ñ","Ù","Ã™","Ã ","Ã¨","Ã¬","Ã²","Ã¹","ç","Ç","Ã¢","ê","Ã®","Ã´","Ã»","Ã‚","ÃŠ","ÃŽ","Ã”","Ã›","ü","Ã¶","Ã–","Ã¯","Ã¤","«","Ò","Ã","Ã„","Ã‹");
      $allowed = array ("a","e","i","o","u","A","E","I","O","U","n","N","n","N","n", "N","A","E","I","O","U","a","e","i","o","u","c","C","a","e","i","o","u","A","E","I","O","U","u","o","O","i","a","e","U","I","A","E");
