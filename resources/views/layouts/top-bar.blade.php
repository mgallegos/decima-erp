<nav id="page-navbar" class="navbar {{ (strpos(URL::to('/'), 'http://localhost') == 0 || strpos(AuthManager::getCurrentUserOrganizationName(), 'Dev') == 0) ? 'navbar-default' : 'navbar-default'  }} navbar-fixed-top" role="navigation">
