...
<script src="https://storage.googleapis.com/decimaerp-cdn-bucket/jquery-mg-validation-v0.6/jquery.jqMgVal.src.js"></script>
{{-- <script src="{{ URL::asset('assets/jquery-mg-validation-v0.6/jquery.jqMgVal.src.js') }}"></script> --}}
{{-- <script src="https://storage.googleapis.com/decimaerp-cdn-bucket/kwaai/js/base-v1.4.4.js"></script> --}}
<script src="{{ URL::asset('assets/kwaai/js/base-v1.4.4.js') }}"></script> 
