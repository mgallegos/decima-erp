  ...
  <div class="container-login">
    <div class="card custom-card shadow">
      <div class="card-body px-3 py-5">
        ...
        @endif
        <form id="decima-form" class="validate-form" role="form" method="POST" accept-charset="UTF-8" action="{{ URL::to('password-reminder/remind') }}" onsubmit="return false;">
          <div id="email-container" class="mt-4">
            <h5 class="card-title text-center">{{ Lang::get('security/reminders.formTitle') }}</h5>
            <div class="form-group mb-1 mt-3 validate-input">
              <label for="decima-email" class="mb-1">{{ Lang::get('security/login.email') }}</label>
              <div>
                <input id="decima-email" type="email" class="form-control" value="{{ $lastLoggedUserEmail }}">
              </div>
            </div>
          </div>
          <div class="d-flex justify-content-end">
            <button id="decima-send" type="button" class="btn btn-primary">
