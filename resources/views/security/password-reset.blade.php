...
@section('container')
	{!! Html::script('assets/kwaai/js/security/password-reset.js') !!}
	<div class="col-md-4 col-md-offset-4">
		<div class="stand-alone-box clearfix">
			<legend class="text-center">{{ Lang::get('security/reminders.formTitle') }}</legend>
			{!! Form::open(array('id'=>'reset-form', 'role' => 'form', 'url' => URL::action('Security\Reminder@postReset'))) !!}
				@if ($error)
				...
				{!! Form::button('<i class="fa fa-refresh"></i> ' . Lang::get('security/reminders.resetButton'), array('id'=>'btn-reset', 'class'=>'btn btn-default center-block', 'onclick' => '$( "#reset-form" ).submit();')) !!}
