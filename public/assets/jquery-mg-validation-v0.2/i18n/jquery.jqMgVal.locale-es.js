/**
* @license jqMgVal  v0.1 - jQuery MG Validation Spanish Translation
...
$.fn.jqMgVal.defaults.lang = {
    requiredFieldText: '* Campo obligatorio',
    ...
    defaultRegexHelpMessage: 'El valor ingresado no es válido.'
};
